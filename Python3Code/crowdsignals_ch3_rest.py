...
#imputed_mean_dataset = MisVal.impute_mean(copy.deepcopy(dataset), 'heartrate')
#imputed_median_dataset = MisVal.impute_median(copy.deepcopy(dataset), 'heartrate')
#imputed_interpolation_dataset = MisVal.impute_interpolate(copy.deepcopy(dataset), 'heartrate')
#DataViz.plot_imputed_values(dataset, ['original', 'mean', 'interpolation'], 'heartrate', imputed_mean_dataset['heartrate'], imputed_interpolation_dataset['heartrate'])
